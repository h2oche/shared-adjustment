    ...
    switch(alertRuleName) {
      case "communication":
        return (<div>
          ...
          <br/>
          <p>점검을 마친 후, 사전에 지정된 학습자가 [점검 완료하기] 버튼을 클릭하면 과제 화면으로 돌아갑니다.</p>
        </div>);
      case "positiveVibe":
        return (<div>
      ...
      case "mission":
        return (<div>
          <p>현재 우리 팀의 많은 팀원들이 <b>[문제의 조건충족]</b> 이 이루어지고 있는지 점검해야 할 필요성을 느끼고 있습니다. </p>
          <p>팀 성과를 높이기 위해서는 주어진 문제를 해결하는 데 고려해야 할 조건, 즉 학습활동 설계에 고려해야 할 조건이 무엇이었는지, 각 조건이 어느 정도 충족되고 있는지 지속적으로 확인해야 합니다.</p>
